...
export default function TranslationsPage() {
  ...
  const [sorting, setSorting] = useState([{ id: 'taskId', desc: false }]);
  ...
  return h('div', { className: 'page' },
    ...
    h('div', { className: 'page-controls' },
      h('input', {
        ...
        placeholder: 'Filter tasks, versions, provider, model, status, session…',
      }),
      h('select', { value: sessionFilter, onChange: event => setSessionFilter(event.target.value), 'aria-label': 'Filter translations by session' },
